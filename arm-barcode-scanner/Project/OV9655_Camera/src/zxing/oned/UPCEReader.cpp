 ...
 */
const int NUMSYS_AND_CHECK_DIGIT_PATTERNS[2][10] = { { 0x38, 0x34, 0x32, 0x31,
		0x2C, 0x26, 0x23, 0x2A, 0x29, 0x25 }, { 0x07, 0x0B, 0x0D, 0x0E, 0x13,
...
int UPCEReader::decodeMiddle(Ref<BitArray> row, Range const& startRange,
		string& result) {
...
bool UPCEReader::determineNumSysAndCheckDigit(std::string& resultString,
		int lgPatternFound) {
