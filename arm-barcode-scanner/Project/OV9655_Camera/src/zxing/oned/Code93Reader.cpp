...
namespace {
char const ALPHABET[] = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*";
 ...
 */
int const CHARACTER_ENCODINGS[] = { 0x114, 0x148, 0x144, 0x142, 0x128, 0x124,
...
int const CHARACTER_ENCODINGS_LENGTH = (int) sizeof(CHARACTER_ENCODINGS)
		/ sizeof(CHARACTER_ENCODINGS[0]);
...
void Code93Reader::checkOneChecksum(string const& result, int checkPosition,
		int weightMax) {
	int weight = 1;
	int total = 0;
