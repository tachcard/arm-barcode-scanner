...
private:
    ...
    static Range findGuardPattern(Ref<BitArray> row, int rowOffset,
            bool whiteFirst, std::vector<int> const& pattern,
...
public:
    ...
    virtual int decodeMiddle(Ref<BitArray> row, Range const& startRange,
    ...
    static int decodeDigit(Ref<BitArray> row, std::vector<int>& counters,
            int rowOffset, std::vector<int const*> const& patterns);
