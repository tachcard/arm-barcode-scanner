...
private:
    enum {
        MAX_AVG_VARIANCE = (unsigned int) (PATTERN_MATCH_RESULT_SCALE_FACTOR
                * 420 / 1000)
    };
    enum {
        MAX_INDIVIDUAL_VARIANCE = (int) (PATTERN_MATCH_RESULT_SCALE_FACTOR * 780
                / 1000)
    };
    ...
    static void decodeMiddle(Ref<BitArray> row, int payloadStart,
    ...
    static Range findGuardPattern(Ref<BitArray> row, int rowOffset,
