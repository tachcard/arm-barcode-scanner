...
unsigned int Version::VERSION_DECODE_INFO[] = { 0x07C94, 0x085BC, 0x09A99,
...
Version::Version(int versionNumber, vector<int> *alignmentPatternCenters,
		...
		ECBlocks *ecBlocks4) :
		versionNumber_(versionNumber), alignmentPatternCenters_(
				*alignmentPatternCenters), ecBlocks_(4), totalCodewords_(0) {
...
Ref<BitMatrix> Version::buildFunctionPattern() {
	...
	for (size_t x = 0; x < max; x++) {
		...
		for (size_t y = 0; y < max; y++) {
			...
			functionPattern->setRegion(alignmentPatternCenters_[y] - 2, i, 5,
					5);
		}
	}
...
int Version::buildVersions() {
	VERSIONS.push_back(
			Ref<Version>(
					new Version(1, intArray(0), new ECBlocks(7, new ECB(1, 19)),
							new ECBlocks(10, new ECB(1, 16)),
							new ECBlocks(13, new ECB(1, 13)),
							new ECBlocks(17, new ECB(1, 9)))));
	VERSIONS.push_back(
			Ref<Version>(
					new Version(2, intArray(2, 6, 18),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(7, intArray(3, 6, 22, 38),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(8, intArray(3, 6, 24, 42),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(9, intArray(3, 6, 26, 46),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(10, intArray(3, 6, 28, 50),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(11, intArray(3, 6, 30, 54),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(12, intArray(3, 6, 32, 58),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(13, intArray(3, 6, 34, 62),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(14, intArray(4, 6, 26, 46, 66),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(15, intArray(4, 6, 26, 48, 70),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(16, intArray(4, 6, 26, 50, 74),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(17, intArray(4, 6, 30, 54, 78),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(18, intArray(4, 6, 30, 56, 82),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(19, intArray(4, 6, 30, 58, 86),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(21, intArray(5, 6, 28, 50, 72, 94),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(22, intArray(5, 6, 26, 50, 74, 98),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(23, intArray(5, 6, 30, 54, 78, 102),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(24, intArray(5, 6, 28, 54, 80, 106),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(25, intArray(5, 6, 32, 58, 84, 110),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(26, intArray(5, 6, 30, 58, 86, 114),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(27, intArray(5, 6, 34, 62, 90, 118),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(28, intArray(6, 6, 26, 50, 74, 98, 122),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(29, intArray(6, 6, 30, 54, 78, 102, 126),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(30, intArray(6, 6, 26, 52, 78, 104, 130),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(31, intArray(6, 6, 30, 56, 82, 108, 134),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(33, intArray(6, 6, 30, 58, 86, 114, 142),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(34, intArray(6, 6, 34, 62, 90, 118, 146),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(35, intArray(7, 6, 30, 54, 78, 102, 126, 150),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(36, intArray(7, 6, 24, 50, 76, 102, 128, 154),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(37, intArray(7, 6, 28, 54, 80, 106, 132, 158),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(38, intArray(7, 6, 32, 58, 84, 110, 136, 162),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(39, intArray(7, 6, 26, 54, 82, 110, 138, 166),
	...
	VERSIONS.push_back(
			Ref<Version>(
					new Version(40, intArray(7, 6, 30, 58, 86, 114, 142, 170),
