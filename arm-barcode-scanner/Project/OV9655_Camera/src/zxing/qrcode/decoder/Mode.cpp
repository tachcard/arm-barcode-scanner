...
Mode::Mode(int cbv0_9, int cbv10_26, int cbv27, int /* bits */,
		char const* name) :
		characterCountBitsForVersions0To9_(cbv0_9), characterCountBitsForVersions10To26_(
				cbv10_26), characterCountBitsForVersions27AndHigher_(cbv27), name_(
				name) {
}
