...
Ref<BitMatrix> GridSampler::sampleGrid(Ref<BitMatrix> image, int dimensionX,
...
Ref<BitMatrix> GridSampler::sampleGrid(Ref<BitMatrix> image, int dimension,
		...
		float p3ToY, float p4ToX, float p4ToY, float p1FromX, float p1FromY,
		float p2FromX, float p2FromY, float p3FromX, float p3FromY,
		float p4FromX, float p4FromY) {
	Ref<PerspectiveTransform> transform(
			PerspectiveTransform::quadrilateralToQuadrilateral(p1ToX, p1ToY,
					p2ToX, p2ToY, p3ToX, p3ToY, p4ToX, p4ToY, p1FromX, p1FromY,
...
void GridSampler::checkAndNudgePoints(Ref<BitMatrix> image,
		vector<float> &points) {
