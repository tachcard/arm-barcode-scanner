...
#include <zxing/datamatrix/decoder/DatamatrixDecodedBitStreamParser.h>
#include <iostream>
...
const char DecodedBitStreamParser::TEXT_SHIFT3_SET_CHARS[] = { '\'', 'A', 'B',
...
int DecodedBitStreamParser::decodeAsciiSegment(Ref<BitSource> bits,
		ostringstream & result, ostringstream & resultTrailer) {
...
void DecodedBitStreamParser::decodeC40Segment(Ref<BitSource> bits,
		ostringstream & result) {
...
void DecodedBitStreamParser::decodeTextSegment(Ref<BitSource> bits,
		ostringstream & result) {
...
void DecodedBitStreamParser::parseTwoBytes(int firstByte, int secondByte,
		int* result) {
...
void DecodedBitStreamParser::decodeBase256Segment(Ref<BitSource> bits,
		ostringstream& result, vector<char> byteSegments) {
