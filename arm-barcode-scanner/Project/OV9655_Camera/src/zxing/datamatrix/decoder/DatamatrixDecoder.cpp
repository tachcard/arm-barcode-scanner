...
#include <zxing/datamatrix/decoder/DatamatrixDecoder.h>
#include <zxing/datamatrix/decoder/DatamatrixBitMatrixParser.h>
#include <zxing/datamatrix/decoder/DatamatrixDataBlock.h>
...
void Decoder::correctErrors(ArrayRef<char> codewordBytes,
...
Ref<DecoderResult> Decoder::decode(Ref<BitMatrix> bits) {
	...
	std::vector<Ref<DataBlock> > dataBlocks = DataBlock::getDataBlocks(
			codewords, version);
