...
char scan_str_buff_1[64];
char scan_str_buff_2[64];

char * scan_str_last = scan_str_buff_1;
char * scan_str_now = scan_str_buff_2;

#define CAMERA_WIDTH    320
#define CAMERA_HEIGHT   240

unsigned int scan_width = 320;
unsigned int scan_height = 240;

#define HORIZONTAL_SCALE_FACTOR 1
...
extern int read_image(char * scan_str);
...
int main(void) {
    ...
    init2.GPIO_Mode = GPIO_Mode_AF;
    init2.GPIO_OType = GPIO_OType_PP;
    init2.GPIO_Pin = GPIO_Pin_1;
